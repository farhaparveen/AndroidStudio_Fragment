 ...
 * Use the {@link RecieverFragment#newInstance} factory method to
...
public class RecieverFragment extends Fragment {
    ...
    private TextView mShow_messageTextView;
    ...
    public static RecieverFragment newInstance(String param1, String param2) {
        RecieverFragment fragment = new RecieverFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mShow_messageTextView = view.findViewById(R.id.show_message);
        return view;
    }
    ...
    public void setData(String message) {
        if (message!=null) {
            mShow_messageTextView.setText(message);
        }
    }
